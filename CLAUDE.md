...
- Branch: `phase-0.5/summary-tile` — Created SummaryTile component (standard/compact modes, trend arrows, value coloring), TrendDirection enum, TZS currency formatter utility (full/short formats), widget and unit tests ⏳ in progress
