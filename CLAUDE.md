...
- Branch: `phase-0.5/offline-banner` — Created OfflineBanner (animated show/hide, offline/syncing states, watches connectivityProvider), ConnectionStatus (dot indicator for AppBar), widgets barrel export for entire Design System, updated HomeScreen demo, widget tests ⏳ in progress
