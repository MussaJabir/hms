...
- Branch: `phase-0.5/loading-shimmer` — Created shimmer loading system: ShimmerEffect (animated gradient), ShimmerBox (placeholder shape), ShimmerCard/ShimmerAlertCard/ShimmerSummaryTile (matching real component layouts), ShimmerList (multiple items), barrel export, widget tests ⏳ in progress
