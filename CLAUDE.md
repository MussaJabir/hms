...
- Branch: `phase-2/dashboard-layout` — Finalized HomeScreen layout (AppBar with notification bell badge + ConnectionStatus, Drawer with navigation and sign out, scrollable body with GroundsSelector → HealthScore → AlertFeed sections), DashboardSectionHeader widget, barrel exports for dashboard widgets and screens ⏳ in progress
